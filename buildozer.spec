...
requirements = python3,kivy,bleak,async_to_sync, async_timeout, schedule, nest_asyncio, kivymd
...
android.add_src = PythonScanCallback.java, PythonBluetoothGattCallback.java
